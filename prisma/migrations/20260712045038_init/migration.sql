...
-- CreateEnum
CREATE TYPE "ExpenseCategory" AS ENUM ('TOLL', 'PARKING', 'MAINTENANCE', 'OTHER');
...
CREATE TABLE "Vehicle" (
    ...
    "model" TEXT,
    "type" TEXT NOT NULL,
    "maxLoadCapacity" DECIMAL(12,2) NOT NULL,
    "odometer" DECIMAL(14,2) NOT NULL,
...
CREATE TABLE "Trip" (
    ...
    "actualDistance" DECIMAL(12,2),
    "finalOdometer" DECIMAL(14,2),
...
-- CreateIndex
CREATE INDEX "FuelLog_vehicleId_loggedAt_idx" ON "FuelLog"("vehicleId", "loggedAt");

-- CreateIndex
CREATE INDEX "FuelLog_tripId_idx" ON "FuelLog"("tripId");

-- CreateIndex
CREATE INDEX "Expense_vehicleId_incurredAt_idx" ON "Expense"("vehicleId", "incurredAt");
